...
import { Building2, MapPin, Briefcase, Search, Map, List, ExternalLink } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto" data-testid="startups-page">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-600 mt-1">Discover opportunities at innovative startups</p>
          </div>
